...
MenuMain::MenuMain() {
		...
		appTitle1 = Screen::getTextSurface(Screen::getHugeFont(), " ", Constants::WHITE_COLOR);
		appTitle2 = Screen::getTextSurface(Screen::getHugeFont(), "ow man", Constants::WHITE_COLOR);
		...
		addMenuItem("Die Again");
		addMenuItem("Poop");
		addMenuItem("Cool Turds");
		addMenuItem("Die");
		addMenuItem("sudo badvirus -hack");
		selection = STARTGAME;
